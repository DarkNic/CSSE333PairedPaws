...
public class CreditCardPage extends JComponent {
	...
	private void loadNext() {
		...
		add(pageTitle_1);
		JLabel lblMonth = new JLabel("Expiration Month");
		...
		add(expYear);
		JLabel lblExpYear = new JLabel("Expiration Year");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!valid) {
					...
					try {
						UserOperations.addCredit(Main.loggedUser, cardNum.getText(),
								expMonth.getText() + "/" + expYear.getText(), cvcNummy.getText(), codeZip.getText(),
								nameCard.getText());
						UserOperations.addAdoption(Main.loggedUser, CreditCardPage.this.curID);
						Thread.sleep(1500);
