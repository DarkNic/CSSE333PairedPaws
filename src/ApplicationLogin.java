...
public class ApplicationLogin {
	...
	public static boolean login(String uname, String pass) {
		...
		try {
			...
			if (!uname.equals(userChallenge) || !hashPW(uname, pass).equals(passChallenge))
	...
	public static boolean register(String uname, String pass, String phone, String email, String addr, String zip,
			String name) {
		uname = uname.toLowerCase();
		String hash = "";
		try {
		...
		int ret = 0;
		try {
			if (uname.equals("") || pass.equals("") || phone.equals("") || email.equals("") || addr.equals("")
					|| zip.equals("") || name.equals("")) {
				ret = 1;
				throw new SQLException();
			}
